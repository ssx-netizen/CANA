...
class DSMILNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.i_classifier = FCLayer(in_size=1024, out_size=n_classes)
        self.b_classifier = BClassifier(input_size=1024, output_class=n_classes, dropout_v=0, nonlinear=0,confounder_path=None)
